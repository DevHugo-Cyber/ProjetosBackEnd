...
const storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    cb(null, file.originalname); // Considere usar uma estratégia de geração de nomes únicos par    a produção
  }
});
...
const routes = (app) => {
  ...
  app.post("/uploads", upload.single("imagem"), uploadImagem); // Chama a função controladora para processamento da imagem
